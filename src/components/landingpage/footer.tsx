                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        ...
                        <ul className="flex justify-center gap-6 mt-8 sm:justify-start md:gap-8">
                            <li>
                                <a href="/" rel="noreferrer" target="_blank" className="text-indigo-700 transition hover:text-indigo-700/75">
                ...
                <div className="pt-6 mt-12 border-t border-gray-100">
                    <div className="text-center sm:flex sm:justify-between sm:text-left">
                        <p className="text-sm text-gray-500">
                            ...
                            <a className="inline-block text-indigo-600 underline transition hover:text-indigo-600/75" href="/">
                                Terms &amp; Conditions
                            </a>
                            <span>·</span>
                            <a className="inline-block text-indigo-600 underline transition hover:text-indigo-600/75" href="/">
