                ...
                <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                    <div className="flex lg:flex-1">
                        <a href="#" className="-m-1.5 p-1.5">
                            <span className="sr-only">Filery</span>
                            <img
                ...
                <div className="max-w-2xl py-32 mx-auto sm:py-48 lg:py-56">
                    ...
                    <div className="text-center">
                        <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                            The ultimate file sharing and storage solution
                        </h1>
                        <p className="mt-6 text-lg leading-8 text-gray-600">
                            Whether you need to send a large file, backup your photos, or access your documents from anywhere, we’ve got you covered. no credit card required, no problem.
                        </p>
